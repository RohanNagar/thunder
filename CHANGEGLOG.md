# v3.0.0
## :eight_spoked_asterisk: Added

- Add allowSubset and allowSuperset options to property validation [#1006](https://github.com/RohanNagar/thunder/pull/1006)
- Return User creationTime and lastUpdateTime with responses [#1002](https://github.com/RohanNagar/thunder/pull/1002)
- Email configuration should specify type [#878](https://github.com/RohanNagar/thunder/issues/878)
- Provide option in property validation to allow extra fields [#877](https://github.com/RohanNagar/thunder/issues/877)
- Salt passwords when doing server-side hash [#867](https://github.com/RohanNagar/thunder/issues/867)
- Support authentication in MongoDB [#859](https://github.com/RohanNagar/thunder/issues/859)
- Allow common password mistakes [#763](https://github.com/RohanNagar/thunder/pull/763)
- Feature: Include Created/Modified Time in User Object [#580](https://github.com/RohanNagar/thunder/issues/580)
- Feature: DB Integration: Mongo DB [#572](https://github.com/RohanNagar/thunder/issues/572)
- Feature: Allow Common Password Mistakes [#571](https://github.com/RohanNagar/thunder/issues/571)
- OpenAPI and Swagger UI Generation & Configuration Options [#570](https://github.com/RohanNagar/thunder/pull/570)
- OpenAPI (Swagger) Integration [#388](https://github.com/RohanNagar/thunder/pull/388)
- Generate OpenAPI/Swagger Definition [#266](https://github.com/RohanNagar/thunder/issues/266)

## :eight_pointed_black_star: Changed

- Populate Swagger version number during build [#993](https://github.com/RohanNagar/thunder/pull/993)
- Update Swagger Project version using resource filtering [#895](https://github.com/RohanNagar/thunder/issues/895)
- Default to disabled email configuration [#887](https://github.com/RohanNagar/thunder/pull/887)
- Default Email to disabled [#886](https://github.com/RohanNagar/thunder/issues/886)
- Swap MD5 to SHA256 [#876](https://github.com/RohanNagar/thunder/pull/876)
- Swap MD5 hash to SHA256 or SHA512 [#875](https://github.com/RohanNagar/thunder/issues/875)
- Add salting to MD5 hash [#874](https://github.com/RohanNagar/thunder/pull/874)
- Create DynamoDB table if it does not exist [#866](https://github.com/RohanNagar/thunder/pull/866)
- Create database table if it doesn't exist [#864](https://github.com/RohanNagar/thunder/issues/864)

## :coffee: Client

- Update Java Client to use CompletableFuture [#851](https://github.com/RohanNagar/thunder/issues/851)

## :arrow_right: DevOps

- Migrate from Travis CI to Github CI [#778](https://github.com/RohanNagar/thunder/issues/778)
- Update the requirements file in /docs with Github Action [#777](https://github.com/RohanNagar/thunder/issues/777)
- Update Create Pull Request GH Action Version [#776](https://github.com/RohanNagar/thunder/issues/776)
- Unit tests and documentation for Helm chart [#582](https://github.com/RohanNagar/thunder/issues/582)
- Add Helm Chart [#581](https://github.com/RohanNagar/thunder/pull/581)
- Auto-Generate Release Changelog [#578](https://github.com/RohanNagar/thunder/issues/578)
- Create Helm Chart for Thunder deployment [#239](https://github.com/RohanNagar/thunder/issues/239)

## :eyeglasses: Notable Dependency Upgrades

- Migrate to Github-Native Dependabot [#814](https://github.com/RohanNagar/thunder/issues/814)
- Upgrade AWS SDK to version 2 [#386](https://github.com/RohanNagar/thunder/pull/386)
- Upgrade AWS SDK to v2 [#356](https://github.com/RohanNagar/thunder/issues/356)

## :heart: Contributors

We'd like to thank all the contributors who worked on this release!

- [@RohanNagar](https://github.com/RohanNagar)
