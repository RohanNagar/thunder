...
class HashAlgorithmTest {
  ...
  void testBcryptResponseTypeMapping() {
    assertAll("Assert equal JSON enum and string value",
        ...
        () -> assertEquals(BCryptHashService.class, HashAlgorithm.BCRYPT.newHashService().getClass()));
  }
  ...
  void testMd5ResponseTypeMapping() {
    assertAll("Assert equal JSON enum and string value",
        ...
        () -> assertEquals(MD5HashService.class, HashAlgorithm.MD5.newHashService().getClass()));
  }
  ...
  void testSimpleResponseTypeMapping() {
    assertAll("Assert equal JSON enum and string value",
        ...
        () -> assertEquals(SimpleHashService.class, HashAlgorithm.SIMPLE.newHashService().getClass()));
  }
  ...
  void testNoneResponseTypeMapping() {
    assertAll("Assert equal JSON enum and string value",
        ...
        () -> assertEquals(SimpleHashService.class, HashAlgorithm.NONE.newHashService().getClass()));
  }
